...
2. ACS Web Calling SDK extended the `file` protocol support for local developement (https://github.com/Azure/Communication/issues/297). Remote access still supports `https` protocol only.
